...
async function createRecipe(data, householdId, userId) {
    ...
    try {
        const { rows } = await pool.query(
            "INSERT INTO recipes (title, description, instructions, link_url, prep_time_minutes, cook_time_minutes, household_id, user_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id",
            [
                recipe_title,
                recipe_description,
                recipe_instructions,
