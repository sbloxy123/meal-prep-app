...
async function weekTotals(endDay, offsetDays) {
    ...
    return {
        ...
        installed: Number(last.installed_users) || 0,
        inApp7d: Number(last.standalone_active_7d) || 0,
...
function digestText({ week, endDay, a, b, url }) {
    ...
    return [
        ...
        line("On a home screen (installed)", a.installed, delta(a.installed, b.installed)),
        line("Used the installed app this week", a.inApp7d, delta(a.inApp7d, b.inApp7d)),
